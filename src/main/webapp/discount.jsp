...
<html lang="en">
<head>
<title>Giảm giá COZA Việt Nam </title>
<meta charset="UTF-8">
		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-15">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					</a> <span class="stext-106 cl4"> Giảm giá </span>
				</div>
			...
			<img width="64" height="64" src="images/icons8-product-64.png" alt="product">
			<span>
				Hiện nhóm sản phẩm này chưa được cập nhật
			</span>
		</div>
			</c:if>
