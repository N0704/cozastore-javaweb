				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title2">Quản lý bộ sưu tập</h4>
							...
							<table class="table table-borderless datatable">						
								<thead>
									<tr>
										<th class="col-1 text-center">COLID</th>
										<th class="col-3 text-center">Tên</th>
										<th class="col-3 text-center">Phong cách</th>
										<th class="col-3 text-center">Hashtag</th>
								...
								<tbody>
									<c:forEach items="${listC}" var="c">
										<tr>
											<th class="text-center" scope="row">BST-${c.collection_id}</th>
											<td class="text-center">${c.name}</td>
											<td class="text-center">${c.style}</td>
											<td class="text-center">${c.hashtag}</td>
											<td class="text-center"><a
												href="loadCollection?collection_id=${c.collection_id}"
												class="btn btn-outline-dark btn-sm" title="Edit"> <i
													class="bi bi-pencil-square"></i>
											</a> <a href="#" class="btn btn-outline-danger btn-sm delete-btn"
												data-collection_id="${c.collection_id}" title="Delete"> <i
													class="bi bi-trash"></i>
											</a></td>
										</tr>
									</c:forEach>
			...
			<div class="modal fade" id="modalAdd" tabindex="-1">
			  <div class="modal-dialog modal-xl modal-dialog-scrollable">
			    <div class="modal-content">
			      <form action="add-collection" method="post" enctype="multipart/form-data">
			          ...
			          <div class="container-fluid">
			            <div class="row">
			              ...
			              <div class="col-md-7 mb-4">
			                <div class="mb-4">
			                  <label for="name" class="form-label text-dark fw-bold">Tên bộ sưu tập</label>
			                  <input name="name" type="text" class="form-control border-dark" id="name" 
			                         value="${detail.name}" placeholder="Nhập tên bộ sưu tập" required>
			                </div>
			                		                
			                 <div class="mb-4">
			                  <label for="style" class="form-label text-dark fw-bold">Phong cách</label>
			                  <input name="style" type="text" class="form-control border-dark" id="style" 
			                         value="${detail.style}" placeholder="Nhập phong cách" required>
			                </div>
			                
			               <div class="mb-4">
			                  <label for="hashtag" class="form-label text-dark fw-bold">Hashtag</label>
			                  <input name="hashtag" type="text" class="form-control border-dark" id="hashtag" 
			                         value="${detail.hashtag}" placeholder="Nhập hashtag" required>
			                </div>
			                </div>
			                
			              <!-- Cột phải: Upload ảnh -->
			              <div class="col-md-5 mb-4">
			                <label class="form-label text-dark fw-bold mb-2">Ảnh bìa <span class="text-danger">*</span></label>
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <form action="edit-collection" method="post" enctype="multipart/form-data">
        <input type="hidden" name="collection_id" value="${detail.collection_id}">
        <div class="modal-header bg-dark text-white">
          <h5 class="modal-title fw-bold">Cập Nhật Bộ Sưu Tập</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close" onclick="window.location.href='collection-manager'"></button>
        </div>
        <div class="modal-body py-4">
          <div class="container-fluid">
            <div class="row">
              ...
              <!-- Cột phải: Upload ảnh -->
              <div class="col-md-5 mb-4">
                <label class="form-label text-dark fw-bold mb-2">Ảnh bìa</label>
        ...
        <div class="modal-footer border-top-0">
          <button type="button" class="btn btn-outline-secondary rounded-pill px-4" data-bs-dismiss="modal" onclick="window.location.href='collection-manager'">Hủy bỏ</button>
