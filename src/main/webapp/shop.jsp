...
<html lang="en">
<head>
<title>${listCC.cname} COZA | COZA Việt Nam Official Website</title>
<meta charset="UTF-8">
...
<body class="animsition">
	...
	<div class="main-title-colleciton p-t-70">
		<h1>${listCC.cname}</h1>
	</div>
	...
	<div class="description-collection" data-language="">
		<div class="container">
			<div class="des-collection-inner">
				<p style="text-align: center;">${listCC.cdesc}</p>
			</div>
		</div>
	</div>
	...
	<!-- Product -->
	<div class="bg0 m-t-23 p-b-75">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-15">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<a href="home" class="stext-106 cl8 hov-cl1 trans-04"> Trang
						chủ <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
					</a> <a href="" class="stext-106 cl8 hov-cl1 trans-04"> Danh mục <i
						class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
					</a> <span class="stext-106 cl4"> ${listCC.cname} </span>
				</div>
				...
				<div class="flex-w flex-c-m m-tb-10">
					...
					<div
						class="flex-c-m stext-106 cl6 size-105 bor4 pointer hov-btn1 trans-04 m-tb-4 js-show-search">
				...
				<form action="search" method="get"
					class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text"
							name="txt" placeholder="Tìm kiếm sản phẩm">
					</div>
				</form>
							...
							<ul>
								<li class="p-b-6"><a href="category?cid=${param.cid}"
									class="filter-link trans-04 ${empty currentPrice ? 'filter-link-active' : ''}">
										Tất cả </a></li>
								<li class="p-b-6"><a
									href="category?cid=${param.cid}&price=under200"
									class="filter-link trans-04 ${currentPrice == 'under200' ? 'filter-link-active' : ''}">
										Dưới 200,000₫ </a></li>
								<li class="p-b-6"><a
									href="category?cid=${param.cid}&price=200to500"
									class="filter-link trans-04 ${currentPrice == '200to500' ? 'filter-link-active' : ''}">
										200,000₫ - 500,000₫ </a></li>
								<li class="p-b-6"><a
									href="category?cid=${param.cid}&price=500to1000"
									class="filter-link trans-04 ${currentPrice == '500to1000' ? 'filter-link-active' : ''}">
										500,000₫ - 1,000,000₫ </a></li>
								<li class="p-b-6"><a
									href="category?cid=${param.cid}&price=over1000"
			...
			<c:if test="${empty listP}">
				<div class="empty-product">
					<img width="64" height="64" src="images/icons8-product-64.png"
						alt="product"> <span> Hiện nhóm sản phẩm này chưa
						được cập nhật </span>
				</div>
			</c:if>
									...
									<div class="new-item-text">
										...
										<div class="flex-sb">
											<div class="dis-flex p-t-5">
												<span class="stext-106 cl13"> <fmt:formatNumber
														value="${o.price * (1 - (o.discount / 100.0))}"
														pattern="#,##0" />₫
												</span>

												<!-- Hiển thị <del> nếu label > 0 -->
												<c:if test="${o.discount > 0}">
													<del class="stext-118 m-l-5 cl9">
														<fmt:formatNumber value="${o.price}" pattern="#,##0" />
														₫
													</del>
												</c:if>
											</div>
